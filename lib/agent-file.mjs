...
export function toAgentDefinition(a) {
  // `tools` toujours présent (liste d'autorisation explicite) : un agent sans outils
  // déclarés reçoit `[]` = AUCUN outil, jamais l'héritage de tous les outils du parent.
  // Garde-fou « n'invente rien » du rédacteur : pas de WebSearch possible.
  const def = { description: a.description, prompt: a.systemPrompt, tools: a.tools || [] };
